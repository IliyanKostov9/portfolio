...
\jobtitle{Zuverlässigkeitsingenieur}{Experian (Bulgarien)}{2026.06 -- gegenwärtig}{}
\small
\begin{itemize}[label=\tiny$\bullet$, leftmargin=1em]
	\item Mitwirkung an der Leistungsoptimierung, Kostenoptimierung und Skalierung von Diensten
	\item Durchführung von Sicherheits- und Compliance-Audits (ISO, SOC2)
	\item Bereitstellung, Betrieb und Optimierung der AWS-Infrastruktur in Hybridumgebungen
\end{itemize}


\jobtitle{DevOps-Ingenieur}{Alten (Frankreich)}{Mai 2025 – gegenwärtig}{}
\small
