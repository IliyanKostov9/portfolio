...
\jobtitle{Ingénieur en fiabilité des sites}{Experian (Bulgarie)}{2026.06 -- présent}{}
\small
\begin{itemize}[label=\tiny$\bullet$, leftmargin=1em]
	\item Participation à l'optimisation des performances, à la réduction des coûts et à la mise à l'échelle des services
	\item Réalisation d'audits de sécurité et de conformité métier (ISO, SOC2)
	\item Mise en place, exploitation et optimisation de l'infrastructure AWS dans des environnements hybrides
\end{itemize}


\jobtitle{Ingénieur DevOps}{Alten (France)}{mai 2025 -- avril 2026}{}
\small
