...
from apps.landing_page.data_class.portfolio.project import Project as ProjectDataClass
...
class ProjectTestCase(Portfolio):
    def test_from_yaml(self):
        ...
        project_model: Any = self.model.apps.get_model("landing_page", "Project")
    ...
    def test_clean(self):
        ...
        projects: list[Project] = (
            self.model.apps.get_model("landing_page", "Project").objects.all().values()
        )
