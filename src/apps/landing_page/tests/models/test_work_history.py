...
from apps.landing_page.data_class.portfolio.work_history import (
...
class WorkHistoryTestCase(Portfolio):
    def test_from_yaml(self):
        ...
        work_history_model: Any = self.model.apps.get_model(
            "landing_page", "WorkHistory"
        )
    ...
    def test_clean(self):
        ...
        work_histories: list[WorkHistory] = (
            self.model.apps.get_model("landing_page", "WorkHistory")
            .objects.all()
            .values()
        )
