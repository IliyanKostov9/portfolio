...
from apps.landing_page.data_class.portfolio.language import (
...
class LanguageTestCase(Portfolio):
    def test_from_yaml(self):
        ...
        language_model: Any = self.model.apps.get_model("landing_page", "Language")
    ...
    def test_clean(self):
        ...
        languages: list[Language] = (
            self.model.apps.get_model("landing_page", "Language").objects.all().values()
        )
